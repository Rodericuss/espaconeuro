defmodule EspacoNeuroWeb.UserAuthTest do
  use EspacoNeuroWeb.ConnCase, async: true

  alias EspacoNeuro.Accounts
  alias EspacoNeuro.Accounts.Scope
  alias EspacoNeuroWeb.UserAuth

  import EspacoNeuro.AccountsFixtures

  @remember_me_cookie "_espaco_neuro_web_user_remember_me"
  @remember_me_cookie_max_age 60 * 60 * 24 * 14

  setup %{conn: conn} do
    conn =
      conn
      |> Map.replace!(:secret_key_base, EspacoNeuroWeb.Endpoint.config(:secret_key_base))
      |> init_test_session(%{})
